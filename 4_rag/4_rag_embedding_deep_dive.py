...
query_vector_store("chroma_db_huggingface_minilm", query, huggingface_embeddings_miniml)
query_vector_store("chroma_db_huggingface_mpnet", query, huggingface_embeddings_mpnet)
